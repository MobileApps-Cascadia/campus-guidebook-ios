...
class SampleData {
    ...
    ["clubs_logo-1",
     ...
     "engineers_club",
     "japanese_culture_club"]
    let eventTitles: [String] = ["Clubs at Cascadia", "DnD Club", "Engineers Club", "Japanese Culture Club"]
    ...
    ["clubs_logo-1",
     ...
     "engineers_club",
     "japanese_culture_club"]
    let sustainabilityTitles: [String] = ["Clubs at Cascadia", "DnD Club", "Engineers Club", "Japanese Culture Club"]
